package src.gleam.content.board {
	 ...
	 * @author Ryuzuka
	 */
	public class Modify extends MovieClip {
		...
		private var urq : URLRequest = new URLRequest("/board/board_modify.php");
		...
		public function initialize() : void {
			...
			for (i = 0; i < arrBox.length; i++) {
				arrBox[i]["x"] = arrBoxPos0[i][0];
				arrBox[i]["y"] = arrBoxPos0[i][1];
			}
		...
		private function setArray() : void {
			...
			arrNameText = ["name", "e - mail", "subject", "password", "modify", "cancel"];
			arrMenu = [box9, box10];
		}
		...
		private function sendData() : void {
			...
			urlVar["changePass"] = arrData[4]["text"];
