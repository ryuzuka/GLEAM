package src.gleam.content.board {
	 ...
	 * @author Ryuzuka
	 */
	public class Reply extends MovieClip {
		...
		private var urq : URLRequest = new URLRequest("/board/board_reply.php");
		...
		private function setArray() : void {
			...
			arrNameText = ["name", "e - mail", "subject", "password", "reply", "cancel"];
			arrMenu = [box9, box10];
		}
		...
		protected function menuMouseEvent(e : MouseEvent) : void {
		...
		private function sendData() : void {
			...
			urlVar["depth"] = String(int(listData["depth" + listIndex]) + 1);
			urlVar["uid"] = String(listData["uid" + listIndex]);
		...
		public function fillData() : void {
			var randomText0 : RandomText = new RandomText(arrData[0], listData["name" + listIndex], "en", 40);
			var randomText1 : RandomText = new RandomText(arrData[1], listData["email" + listIndex], "num", 40);
			var randomText2 : RandomText = new RandomText(arrData[2], listData["subject" + listIndex], "kr", 40);
			randomText0.start("forward");
			randomText1.start("forward");
			randomText2.start("forward");
			arrData[3]["text"] = listData["message" + listIndex];
			TweenMax.from(arrData[3], 0.5, {alpha:0, ease:Expo.easeInOut});
		}
